...
struct class_$statementsDummyClass_struct {
	...
	obj_Obj (*PRINT)  ( obj_$statementsDummyClass );
...
obj_Obj String_method_PRINT(obj_String this );
...
obj_Obj P_method_PRINT(obj_P this );
...
obj_Obj $statementsDummyClass_method_PRINT(obj_$statementsDummyClass this );
